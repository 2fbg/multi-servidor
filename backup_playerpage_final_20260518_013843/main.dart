...
class _HomePageState extends State<HomePage> {
  ...
  List<StreamItem> cachedLive = [];
  List<StreamItem> cachedMovies = [];
  List<StreamItem> cachedSeries = [];
  ...
  Future<void> loadSelectedList({
    ...
    try {
      ...
      cachedLive = items.where((e) => e.kind == ItemKind.live && !isRestrictedIptvItem(e)).toList();
      cachedMovies = items.where((e) => e.kind == ItemKind.movie && !isRestrictedIptvItem(e)).toList();
      cachedSeries = items.where((e) => e.kind == ItemKind.series && !isRestrictedIptvItem(e)).toList();
  ...
  Future<void> initPlayer() async {
    try {
      ...
      chewie = ChewieController(
        ...
        showControls: true,
        aspectRatio:
            video!.value.aspectRatio  ? 16 / 9 : video!.value.aspectRatio,
